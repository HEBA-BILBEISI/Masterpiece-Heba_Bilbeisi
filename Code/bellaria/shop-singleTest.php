...
<!--Page Title-->
<section class="page-title" style="background-image:url('images/pro.jpg')">
    <?php
                                    ...
                                    <div>
                                        <div class='details-header'>
                                            ...
                                            <?php
                                                    ...
                                                    ?>
                                            <br>
                                            <div class='text'>We carefully select the best quality coffee and beans to
                                                make you enjoy the wonderful taste with your loved ones </div>
                                        </div>

                                        <form action="shopping-cart.php" method='get'>
                                            <div class='other-options clearfix'>
                                                <div class='item-quantity'>Quantity
                                                    <input name="quantity" min=1 type="number" id='quantity' class="qty"
                                                        value="<?php echo $pro_qty; ?>">
                                                    <input name="price" type="hidden"
                                                        value="<?php echo $pro['pro_price']; ?>">
                                                </div>
                                                <button type="submit" name="product" class="theme-btn add-to-cart"
                                                    value="<?php echo $pro['pro_id']; ?>">Add to cart</button>
                                            </div>
