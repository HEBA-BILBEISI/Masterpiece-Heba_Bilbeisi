            ...
            <nav class="navbar-mobile rem10">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li>
                            <a href="Manage_Stors.php" style="color: #713523;">
                                <i class="fas fa-chart-bar"></i>Manage Stores</a>
                        </li>
                        <li>
                            <a href="manage_admin.php" style="color: #713523;">
                                <i class="fas fa-chart-bar"></i>Manage Admin</a>
                        </li>
                        <li>
                            <a href="Manage_Category.php" style="color: #713523;">
                                <i class="fas fa-chart-bar"></i>Manage Category</a>
                        </li>
                        <li>
                            <a href="Manage_products.php" style="color: #713523;">
                                <i class="fas fa-chart-bar"></i>Manage products</a>
                        </li>
                        <li>
                            <a href="manage_users.php" style="color: #713523;">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="manage_admin.php">
                    <img src="images/icon/logo.png" alt="Cool Admin" style="width: 7vw;" />
                    <!-- <p>logo</p> -->
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content rem10">
                                            <a class="js-acc-btn" href="#"
                                                style="color: #713523;"><?php echo $_SESSION['admin_name']; ?></a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">

                                            <div class="account-dropdown__footer">
                                                <a href="logout.php" style="color: #713523;">
